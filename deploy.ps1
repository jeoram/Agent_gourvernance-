...
Write-Host "   Initialisation de Git - Agent de Gouvernance IA MGEN" -ForegroundColor Cyan
Write-Host "======================================================================" -ForegroundColor Cyan
...
git commit -m "Initial commit: Agent de Gouvernance IA MGEN"

# 4. Configurer le dépôt distant
$remoteUrl = "https://github.com/jeoram/mgen-ai-governance-agent.git"
...
Write-Host "1. Créez un dépôt public vide nommé 'mgen-ai-governance-agent' sur votre compte GitHub (https://github.com/new)." -ForegroundColor White
