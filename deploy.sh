...
echo -e "\033[0;36m   Initialisation de Git - Agent de Gouvernance IA MGEN\033[0m"
echo -e "\033[0;36m======================================================================\033[0m"
...
REMOTE_URL="https://github.com/jeoram/mgen-ai-governance-agent.git"
...
echo "1. Créez un dépôt public vide nommé 'mgen-ai-governance-agent' sur votre compte GitHub (https://github.com/new)."
